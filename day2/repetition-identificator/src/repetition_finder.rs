...
impl Range {
    ...
    pub fn find_repetition_unrestricted_rec_string(remaining_half_length: u64) -> Vec<String> {
...
mod test {
    ...
    fn find_repetitions_111111_333333() {
        ...
        // TODO: update expected, but don't actually because wtf
        let expected = vec![
            1111, 1212, 1313, 1414, 1515, 1616, 1717, 1818, 1919, 2020, 2121, 2222, 2323, 2424,
            2525, 2626, 2727, 2828, 2929, 3030, 3131, 3232, 3333,
        ];
    ...
    fn find_repetition_lower_restriction_1111_3333() {
        ...
        let result = Range::find_repetition_lower_restriction(lower_first_half, n);
    ...
    fn find_repetition_lower_restriction_111111_333333() {
        ...
        let expected = vec![
            111111, 112112, 113113, 114114, 115115, 116116, 117117, 118118, 119119, 121121, 122122,
            123123, 124124, 125125, 126126, 127127, 128128, 129129, 131131, 132132, 133133, 134134,
            135135, 136136, 137137, 138138, 139139, 141141, 142142, 143143, 144144, 145145, 146146,
            147147, 148148, 149149, 151151, 152152, 153153, 154154, 155155, 156156, 157157, 158158,
            159159, 161161, 162162, 163163, 164164, 165165, 166166, 167167, 168168, 169169, 171171,
            172172, 173173, 174174, 175175, 176176, 177177, 178178, 179179, 181181, 182182, 183183,
            184184, 185185, 186186, 187187, 188188, 189189, 191191, 192192, 193193, 194194, 195195,
            196196, 197197, 198198, 199199,
        ];
    ...
    fn find_repetition_upper_restriction_1111_3333() {
        ...
        let result =
            Range::find_repetition_upper_restriction(lower_first_half, upper_first_half, n);
