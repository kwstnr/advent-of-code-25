...
fn find_restricted_repetition_upper_string_11111111_33333333() {
    ...
    let result = Range::find_restricted_repetition_rec_string(Restriction::UPPER(input)).sort();
...
fn find_restricted_repetition_lower_11111111_33333333() {
    ...
    let result = Range::find_restricted_repetition_rec_string(Restriction::LOWER(input)).sort();
