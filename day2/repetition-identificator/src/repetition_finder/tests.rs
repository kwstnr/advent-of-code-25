...
#[test]
fn find_repetition_lower_restriction_rec_string_1111_3333() {
    let input = vec![1];
    ...
    let result = Range::find_repetition_lower_restriction_rec_string(input);

    assert_eq!(expected, result);
}

#[test]
fn find_repetition_lower_restriction_string_111111_333333() {
    let input = vec![1, 1];
...
#[test]
fn find_repetition_lower_restriction_string_11111111_33333333() {
    let input = vec![1, 1, 1];
    ...
    let result = Range::find_repetition_lower_restriction_rec_string(input).sort();

    assert_eq!(expected, result);
}

#[test]
fn find_repetition_upper_restriction_rec_string_1111_3333() {
    let input = vec![3];
    ...
    let result = Range::find_repetition_upper_restriction_rec_string(input);

    assert_eq!(expected, result);
}

#[test]
fn find_repetition_upper_restriction_rec_string_111111_333333() {
    let input = vec![3, 3];
...
#[test]
fn find_repetition_upper_restriction_string_11111111_33333333() {
    let input = vec![3, 3, 3];
    ...
    let result = Range::find_repetition_upper_restriction_rec_string(input).sort();
